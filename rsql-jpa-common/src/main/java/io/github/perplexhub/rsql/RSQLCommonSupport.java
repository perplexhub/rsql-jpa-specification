...
public class RSQLCommonSupport {
	...
	public RSQLCommonSupport(Map<String, EntityManager> entityManagerMap) {
		RSQLCommonVisitorBase.setEntityManagerMap(getEntityManagerMap());
		RSQLCommonVisitorBase.setManagedTypeMap(getManagedTypeMap());
		RSQLCommonVisitorBase.setPropertyPathMapper(getPropertyPathMapper());
		RSQLCommonVisitorBase.setPropertyRemapping(getPropertyRemapping());
		RSQLCommonVisitorBase.setValueParserMap(getValueParserMap());
	...
	protected String getVersion() {
		try {
			...
			prop.load(getClass().getResourceAsStream("/META-INF/maven/io.github.perplexhub/rsql-jpa-common/pom.properties"));
