...
public abstract class RSQLVisitorBase<R, A> implements RSQLVisitor<R, A> {
    ...
    protected <T> boolean isElementCollectionType(String property, ManagedType<T> classMetadata) {
        return classMetadata.getAttribute(property).getPersistentAttributeType().equals(PersistentAttributeType.ELEMENT_COLLECTION);
    }

    @Getter
    @RequiredArgsConstructor
    protected static class CollectionAttribute implements Attribute {
        private final String name;
        private final Class javaType;
        private PersistentAttributeType persistentAttributeType = PersistentAttributeType.ELEMENT_COLLECTION;
        private ManagedType declaringType;
        private java.lang.reflect.Member javaMember;
